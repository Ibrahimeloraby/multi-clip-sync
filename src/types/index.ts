// All domain types for LoyaltyOne, defined locally in the web app.
// The packages/shared directory has a parallel copy for Node.js workers.

export type ReputationTier = "newcomer" | "contributor" | "trusted" | "expert" | "maven";
export type UserGoal = "max_cashback" | "travel_miles" | "entertainment" | "use_before_expiry";
...
export interface Program {
  ...
  expiry_rule: ExpiryRule | Record<string, unknown>;
...
export interface Merchant {
  ...
  category: string[];
  logo_url: string | null;
  location_data: MerchantLocationData | Record<string, unknown>;
  is_verified: boolean;
...
export interface Transaction {
  ...
  created_at: string;
  merchant?: Pick<Merchant, "display_name_en" | "display_name_ar" | "logo_url">;
}
...
export interface RuleSanityResult {
  is_sane: boolean;
  flags: string[];
